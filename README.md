...
The example app demonstrates both basic and advanced usage of `s_disabled`.

![Basic usage](https://raw.githubusercontent.com/SoundSliced/s_disabled/main/example/assets/example.gif)
...
dependencies:
  s_disabled:
    git: https://github.com/SoundSliced/s_disabled.git
```
...
The example demonstrates best practices for integrating s_disabled into your Flutter applications, including:
...
https://github.com/SoundSliced/s_disabled
